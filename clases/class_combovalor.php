...
class Combovalor{
    ...
    public function Activar($user){
	    ...
	    cmodificado_por='$user' WHERE nid_combovalor='$this->nid_combovalor'";
	    if($this->pgsql->Ejecutar($sql)!=null)
			return true;
		else
			return false;
    ...
    public function Desactivar($user){
    	...
    	OR EXISTS (SELECT 1 FROM inventario.tinventario i WHERE i.nestatus_inventario = cv.nid_combovalor))";
