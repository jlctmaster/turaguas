<?php
 ...
 public function crif_personacliente(){
   ...
   public function Consultar(){
    $sql="SELECT pc.nid_personacontacto,p.crif_persona crif_personacliente,p.cnombre cnombrecliente,pc.nid_direcciondespacho,dp.cdireccion,
  ...
  $this->nid_personacontacto($tpersonas['nid_personacontacto']);
	$this->crif_personacliente($tpersonas['crif_personacliente']);
	$this->cnombrecliente($tpersonas['cnombrecliente']);
