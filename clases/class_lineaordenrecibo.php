...
class Detalle_Documento{
    ...
    public function Actualizar($user){
   	...
   	public function Consultar(){
	    $sql="SELECT dd.nid_detalledocumento,d.nid_documento,TRIM(d.nnro_ent_recib) nnro_ent_recib,TO_CHAR(d.dfecha_ent_recib,'DD/MM/YYYY') dfecha_ent_recib,dd.nlinea,
	    ...
	    if($this->pgsql->Total_Filas($query)!=0){
			...
			$this->nnro_ent_recib($detalle_documento['nnro_ent_recib']);
			$this->dfecha_ent_recib($detalle_documento['dfecha_ent_recib']);
   	...
   	public function Comprobar(){
	    $sql="SELECT dd.nid_detalledocumento,d.nid_documento,TRIM(d.nnro_ent_recib) nnro_ent_recib,dd.nlinea,dd.cid_articulo,dd.ncantidad_articulo, 
