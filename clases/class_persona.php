<?php
 ...
 public function Transaccion($value){
   ...
   public function Registrar($user){
    $sql="INSERT INTO general.tpersona (crif_persona,cnombre,cdireccion,ctelefhab,ctelefmov,cemail,nid_localidad,nid_rol,dcreado_desde,ccreado_por,dmodificado_desde,
      cmodificado_por) VALUES ('$this->crif_persona','$this->cnombre','$this->cdireccion','$this->ctelefhab','$this->ctelefmov','$this->cemail','$this->nid_localidad'
    	,'$this->nid_rol',NOW(),'$user',NOW(),'$user')";
