   ...
   //Cabecera de página
    ...
    public function Header()
    {
      ...
      $this->Ln(55);  
       ...
       $this->Cell(0,6,'CANTIDAD DE REEMBOLSO POR CLIENTE',0,1,"C");
     ...
     $this->SetFillColor(0,0,140); 
      ...
      $this->Cell($anchura*4,$altura,'CLIENTE',1,0,'L',$color_fondo); 
...
function NbLines($w,$txt)
{
  ...
  $pgsql=new Conexion();
    $sql="SELECT TRIM(dp.nnro_devolucion) nnro_devolucion, TO_CHAR(dp.dfecha_devolucion,'DD/MM/YYYY') dfecha_devolucion, 
          ...
          COUNT(rp.cid_articulo) cantidad,p.crif_persona||' '||p.cnombre cliente,md.cdescripcion motivoreembolso
