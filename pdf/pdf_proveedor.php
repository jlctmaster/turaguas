<?php
  ...
  $this->Image("../images/logo2.jpg" ,125,75,45,90, "JPG" ,$_SERVER['HTTP_HOST']."/turaguas/vistas/menu_principal");
   ...
   $this->Cell(0,6,'LISTADO DE LOS PROVEEDORES',0,1,"C");
   $this->Ln(8);
     ...
     $this->SetFillColor(0,0,140); 
      ...
      $this->Cell($anchura*5,$altura,'NOMBRE COMPLETO',1,0,'L',$color_fondo); 
      $this->Cell($anchura*4,$altura,'TELF. HABITACIÓN',1,0,'L',$color_fondo);
      $this->Cell($anchura*5,$altura,'CORREO ELECTRÓNICO',1,0,'L',$color_fondo);
  ...
  function NbLines($w,$txt)
  {
   ...
   //Table with 20 rows and 5 columns
      $lobjPdf->SetWidths(array(20,50,40,50,60,26));
  require_once("../clases/class_bd.php");
  $pgsql=new Conexion();

    $sql="SELECT p.crif_persona,p.cnombre,p.ctelefhab,p.cemail,p.cdireccion,v.cdescripcion, 
  ...
  $data=$pgsql->Ejecutar($sql);
    if($pgsql->Total_Filas($data)!=0){
         ...
         ucwords($tperfil['ctelefhab']),
         ucwords($tperfil['cemail']),
