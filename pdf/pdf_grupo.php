<?php
  ...
  class clsFpdf extends FPDF {
   ...
   $this->Cell(0,6,'LISTADO DE GRUPO DE MOTIVO DEVOLUCIÓN',0,1,"C");
   $this->Ln(8);
     ...
     $this->SetFillColor(0,0,140); 
      ...
      $this->Cell($anchura*6,$altura,'GRUPO MOTIVOS',1,0,'L',$color_fondo); 
...
function NbLines($w,$txt)
{
   ...
   //Table with 20 rows and 5 columns
      $lobjPdf->SetWidths(array(20,60,26));
  require_once("../clases/class_bd.php");
  $pgsql=new Conexion();
    $sql="SELECT LOWER(cdescripcion) as grupo,nid_motivodevolucion as id,
