<?php
  ...
  class clsFpdf extends FPDF {
   ...
   $this->Cell(0,6,'LISTADO DE LOS MÓDULOS',0,1,"C");
   $this->Ln(8);
     ...
     $this->SetFillColor(0,0,140); 
      ...
      $this->Cell($anchura*3,$altura,'MÓDULO',1,0,'L',$color_fondo);
      $this->Cell($anchura*3,$altura,'ÍCONO',1,0,'L',$color_fondo);  
...
FROM seguridad.tmodulo
ORDER BY LOWER(cnombremodulo) DESC";
   $i=-1;
  $data=$pgsql->Ejecutar($sql);
    if($pgsql->Total_Filas($data)!=0){
         ...
         ucwords($tperfil['cnombremodulo']),
         ucwords($tperfil['cicono']),
