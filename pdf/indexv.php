<?php
    ...
    class clsFpdf extends FPDF {
        ...
        public function Header(){
            ...
            $this->Image("../images/BANNER_TURAGUAS.jpg" , 10 ,5, 40 , 40, "JPG" ,$_SERVER['HTTP_HOST']."/turaguas/vistas/");
            $this->Ln(2);	
            $this->SetFont('Arial','',10);	
            $this->Cell(0,6,utf8_decode("REPÚBLICA BOLIVARIANA DE VENEZUELA"),0,1,"C");
            $this->Cell(0,6,utf8_decode("MINISTERIO DEL PODER POPULAR PARA LAS COMUNAS Y LOS MOVIMIENTOS SOCIALES"),0,1,"C");
            $this->SetFont('Arial','B',10);	
            $this->Cell(0,6,utf8_decode("EMPRESA DE PROPIEDAD SOCIAL INDIRECTA COMUNAL"),0,1,"C");
            $this->SetFont('Arial','',10);	
            $this->Cell(0,6,utf8_decode("EL FUTUTO DE LAS TURAGUAS"),0,1,"C");
