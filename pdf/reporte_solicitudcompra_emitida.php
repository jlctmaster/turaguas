   ...
   //Cabecera de página
    public function Header()
    {
      ...
      $this->Ln(55);  
       ...
       $this->Cell(0,6,'SOLICITUDES DE COMPRAS',0,1,"C");
...
function NbLines($w,$txt)
{
  ...
  $pgsql=new Conexion();
    $sql="SELECT nnro_solicitud,TO_CHAR(dfecha_documento,'DD/MM/YYYY') fecha,COUNT(cid_articulo) articulo, 
    SUM(ncantidad_articulo) cant 
