   ...
   //Cabecera de página
    ...
    public function Header()
    {
      ...
      $this->Ln(55);  
       ...
       $this->Cell(0,6,'CANTIDAD DE NOTAS DE DEVOLUCIÓN POR CLIENTE',0,1,"C");
     ...
     $this->SetFillColor(0,0,140); 
      ...
      $this->Cell($anchura*3,$altura,'NRO. ENTREGA',1,0,'L',$color_fondo); 
      $this->Cell($anchura*3.5,$altura,'FECHA ENTREGA',1,0,'L',$color_fondo); 
      $this->Cell($anchura*5,$altura,'CLIENTE',1,0,'L',$color_fondo); 
...
function NbLines($w,$txt)
{
   ...
   //Table with 20 rows and 5 columns
      $lobjPdf->SetWidths(array(35,25,30,35,50,35,45));
  ...
  $pgsql=new Conexion();
    $sql="SELECT TRIM(dc.nnro_devolucion) nnro_devolucion, TO_CHAR(dc.dfecha_devolucion,'DD/MM/YYYY') dfecha_devolucion,
            ...
            CASE WHEN dc.dfecha_devolucion IS NULL THEN 'Activo' ELSE 'Desactivado' END estatus
            ...
            INNER JOIN facturacion.tmotivo_devolucion md ON dc.nid_motivodevolucion = md.nid_motivodevolucion WHERE e.dfecha_entrega between '$dfecha_desde' and '$dfecha_hasta'
...
$i=-1;
  $data=$pgsql->Ejecutar($sql);
    if($pgsql->Total_Filas($data)!=0){
         ...
         ucwords($tperfil['nnro_entrega']),
         ucwords($tperfil['dfecha_entrega']),
