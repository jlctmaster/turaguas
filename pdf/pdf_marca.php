   ...
   //Cabecera de página
    public function Header()
    {
      ...
      $this->Ln(55);  
       ...
       $this->Cell(0,6,'LISTADO DE LAS MARCAS',0,1,"C");
       $this->Ln(8);
     ...
     $this->SetFillColor(0,0,140); 
      ...
      $this->Cell($anchura*2,$altura,'MARCA',1,0,'L',$color_fondo); 
...
function NbLines($w,$txt)
{
  ...
  $pgsql=new Conexion();
    $sql="SELECT LOWER(cdescripcion) as marca,nid_marca as id, 
