<?php
  ...
  $this->Image("../images/logo2.jpg" ,125,75,45,90, "JPG" ,$_SERVER['HTTP_HOST']."/turaguas/vistas/menu_principal");
   ...
   $this->Cell(0,6,'LISTADO DE LOS CONTACTOS DE LOS CLIENTES',0,1,"C");
   $this->Ln(8);
...
$sql="SELECT pc.crif_persona,pc.cnombre,d.cdireccion,pc.ccargo,pc.ctelefono,
      ...
      INNER JOIN general.tcombo_valor v on p.ntipo_persona=v.nid_combovalor WHERE lower(v.cdescripcion) LIKE '%cliente%'  
