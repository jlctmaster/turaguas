   ...
   //Cabecera de página
    public function Header()
    {
      ...
      $this->Ln(55);  
       ...
       $this->Cell(0,6,'LISTADO DE LOS TIPOS DE ARTÍCULOS',0,1,"C");
       $this->Ln(8);
...
function NbLines($w,$txt)
{
   ...
   //Table with 20 rows and 5 columns
      $lobjPdf->SetWidths(array(20,30,26));
  require_once("../clases/class_bd.php");
  $pgsql=new Conexion();
    $sql="SELECT LOWER(cdescripcion) as nombre,nid_tipoarticulo as id, 
    CASE WHEN dfecha_desactivacion IS NULL THEN 'Activo' ELSE 'Desactivado' END estatus 
FROM inventario.ttipo_articulo
ORDER BY LOWER(cdescripcion) DESC";
   $i=-1;
