  ...
  class clsFpdf extends FPDF {
   ...
   $this->Ln(8);
     ...
     $this->SetFillColor(0,0,140); 
      ...
      $this->Cell($anchura*4,$altura,'CÓDIGO PAÍS',1,0,'L',$color_fondo);
      $this->Cell($anchura*3,$altura,'PAÍS',1,0,'L',$color_fondo); 
...
function NbLines($w,$txt)
{
  ...
  $pgsql=new Conexion();
    $sql="SELECT e.nid_localidad,LOWER(e.cdescripcion) estado,e.nid_localidad_padre,LOWER(p.cdescripcion) pais, 
