<?php
  ...
  $this->Image("../images/logo2.jpg" ,125,75,45,90, "JPG" ,$_SERVER['HTTP_HOST']."/turaguas/vistas/menu_principal");
   ...
   $this->Cell(0,6,'LISTADO DE LOS EMPLEADOS',0,1,"C");
   $this->Ln(8);
     ...
     $this->SetFillColor(0,0,140); 
      ...
      $this->Cell($anchura*3,$altura,'ROL',1,0,'L',$color_fondo);
...
function NbLines($w,$txt)
{
   ...
   //Table with 20 rows and 5 columns
      $lobjPdf->SetWidths(array(20,50,40,50,30,26));
  ...
  $pgsql=new Conexion();
    ...
    WHERE lower(v.cdescripcion) LIKE '%empleado%' 
