<?php
  ...
  class clsFpdf extends FPDF {
   ...
   $this->Cell(0,6,'LISTADO DE LAS UBICACIONES',0,1,"C");
   $this->Ln(8);
     ...
     $this->SetFillColor(0,0,140); 
      ...
      $this->Cell($anchura*5,$altura,'PUNTO DE REFERENCIA',1,0,'L',$color_fondo);
...
function NbLines($w,$txt)
{
   ...
   //Table with 20 rows and 5 columns
      $lobjPdf->SetWidths(array(20,30,50,26));
  require_once("../clases/class_bd.php");
    $pgsql=new Conexion();
    $sql="SELECT LOWER(cdescripcion) as ubicacion,nid_ubicacion as id,LOWER(cpunto_referencia) as referencia,
    CASE WHEN dfecha_desactivacion IS NULL THEN 'Activo' ELSE 'Desactivado' END estatus 
    FROM inventario.tubicacion
