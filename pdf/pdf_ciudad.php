<?php
  ...
  class clsFpdf extends FPDF {
   ...
   $this->Cell(0,6,'LISTADO DE LOS CIUDADES',0,1,"C");
   $this->Ln(8);
     ...
     $this->SetFillColor(0,0,140); 
      ...
      $this->Cell($anchura*4,$altura,'CÓDIGO ESTADO',1,0,'L',$color_fondo);
      $this->Cell($anchura*3,$altura,'ESTADO',1,0,'L',$color_fondo); 
...
function NbLines($w,$txt)
{
  ...
  $pgsql=new Conexion();
    $sql="SELECT c.nid_localidad_padre,LOWER(e.cdescripcion) estado,c.nid_localidad,LOWER(c.cdescripcion) ciudad,
    CASE WHEN c.dfecha_desactivacion IS NULL THEN 'Activo' ELSE 'Desactivado' END estatus  
