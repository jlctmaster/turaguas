   ...
   $this->Ln(8);
     ...
     $this->SetFillColor(0,0,140); 
         ...
         $this->SetTextColor(0,0,0);
                $this->Cell($avnzar); 
      $this->Cell($anchura*4,$altura,'CÓDIGO PARROQUIA',1,0,'L',$color_fondo); 
      $this->Cell($anchura*3,$altura,'PARROQUIA',1,0,'L',$color_fondo); 
...
function NbLines($w,$txt)
{
  ...
  $pgsql=new Conexion();
    $sql="SELECT p.nid_localidad_padre,LOWER(m.cdescripcion) municipio,p.nid_localidad,LOWER(p.cdescripcion) parroquia, 
