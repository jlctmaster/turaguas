<?php
  ...
  class clsFpdf extends FPDF {
   ...
   $this->Cell(0,6,'LISTADO DE LAS CONDICIONES DE PAGO',0,1,"C");
   $this->Ln(8);
     ...
     $this->SetFillColor(0,0,140); 
      ...
      $this->Cell($anchura*5,$altura,'CONDICIÓN DE PAGO',1,0,'L',$color_fondo); 
...
function NbLines($w,$txt)
{
  ...
  $pgsql=new Conexion();
    $sql="SELECT LOWER(cdescripcion) as condicionpago,nid_condicionpago as id,
