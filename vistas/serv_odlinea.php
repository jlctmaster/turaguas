<div class="form_externo" >
  ...
  if(isset($_SESSION['datos'])){
    ...
    @$dfecha_ent_despacho=$_SESSION['datos']['dfecha_ent_despacho'];
  ...
  <fieldset style="padding: 30px">
    <form action="../controladores/control_lineaordendespacho.php" method="post" id="form2">
      <table border="0" style="width: 100%">
        ...
        <tr>
          ...
          <td><input title="Correlativo para las líneas de la orden de despacho" name="nlinea" id="nlinea" type="text" size="10" value="<? if(empty($nlinea)){echo "1";}else{echo $nlinea;}?>" /></td>
        </tr>
        <tr>
          <?php
        ...
        <tr>
          <td colspan="2" style="padding-top:12px;padding-bottom:12px; ">
            ...
            <?php
              imprimir_boton($disabledRCOCL,$disabledMDOCL,$estatusocl,$servicios,"lineaordendespacho");
            ?>         
          </td>
        </tr>
      </table>
  ...
  <script type="text/javascript">
    function reload_tablinea(tab){
      ...
      location.href="menu_principal.php?ordendespacho&l&cid_articulo="+cid_articulo+tab;
    }
  </script>
  <table border="0" style="width: 100%"> 
    <tr>
  ...
  <table align="center">  
    <tr>
      <td>
        <input type="button" class="btn btn-default" value="Buscar" onclick="reload_tablinea('#lineaordendespacho')">
        <input type="button" class="btn btn-default" value="Limpiar" onclick="limpiar()">
      </td>
    </tr>
  </table> 
  <a href="?ordendespacho#lineaordendespacho" ><img src="../images/cerrar.png" alt="Cerrar" style="width:40px;heigth:40px;float:right;"></a>
  <a href="../excel/excel_lineaordendespacho.php" ><img src="../images/icon-excel.png" alt="Exportar a Excel" style="width:40px;heigth:40px;float:right;"></a>
  <a href="<?php echo  '../pdf/?serv=lineaordendespacho';?>" target="_blank"><img src="../images/icon-pdf.png" alt="Exportar a PDF" style="width:40px;heigth:40px;float:right;"></a>
  <table style="width:100%;" class="tablapaginacion">
    <tr style="background: #000; color:#FFF; width:100%;"> 
      <td style="width:20%;">Nro. Órden Despacho</td>
    ...
    require_once("../clases/class_bd.php");
    $pgsql=new Conexion();
    $clausuleWhere = "WHERE d.nnro_ent_recib = '".$_SESSION['nnro_ent_recib']."' AND d.ctipo_transaccion = 'V' ";
    if($cid_articulo!=""){
    ...
    while($row = pg_fetch_array($_pagi_result)){ 
      echo "<tr style='cursor: pointer;' id='".$row['nid_documento']."|".$row['nlinea']."' onclick='enviarFormLOD(this.id)'>
