...
<body>
	...
	<div class="cuerpo">
		...
		<div class="centro"><span>
				...
				$pgsql=new Conexion();
	            $sql = "SELECT ctlf_empresa, cemail_empresa, cdireccion_empresa FROM seguridad.tsistema";
	            $query = $pgsql->Ejecutar($sql);
	            while ($row = $pgsql->Respuesta($query)){
	            	echo "<b>Dirección:</b> ".$row['cdireccion_empresa']."<br />";
			echo "<b>Teléfono:</b> ".$row['ctlf_empresa']."<br />";
			echo "<b>Correo:</b>  ".$row['cemail_empresa'];
	            }
				?> </p>
                </span></div>
