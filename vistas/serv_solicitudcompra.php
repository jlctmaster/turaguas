<div class="well">
  <ul class="nav nav-tabs">
    <li class="active"><a href="#solicitudcompra" data-toggle="tab" id="tab-solicitudcompra">Solicitud de Compra</a></li>
  </ul>
  <div id="myTabContent" class="tab-content">
    <script src="../js/eft_solicitudcompra.js"> </script>
    <div class="tab-pane active in" id="solicitudcompra">
      <div class="form_externo" >
        <?php
          if(isset($_SESSION['datos']['nnro_solicitud'])){ 
            $disabledRC='disabled';
            $disabledMD='';
            $estatus=null;
          }else {
        ...
        <fieldset style="padding: 30px">
          <form action="../controladores/control_solicitudcompra.php" method="post" id="form">
            <table border="0" style="width: 100%">
              <tr>
                <td><span class="texto_form">Nro. Solicitud</span></td>
                <td>
                  ...
                  <?php 
                    ...
                    $sql="SELECT nid_tipodocumento,cdescripcion FROM facturacion.ttipo_documento WHERE ctipo_transaccion = 'C' 
                         AND dfecha_desactivacion IS NULL AND (LOWER(cdescripcion) LIKE '%sc%' OR LOWER(cdescripcion) LIKE '%solicitud de compra%' OR LOWER(cdescripcion) LIKE '%compra%')
                  ...
                  ?>
                  <input onKeyPress="return isNumberDocKey(event)" title="El número de la solicitud es generada por el sistema" name="nnro_solicitud" id="nnro_solicitud" type="text" maxlength="10" value="<?= $nnro_solicitud;?>" />
                </td>
              </tr>
              <tr>
                <td>
            ...
            <div class="table-responsive">
              <table id='TablaArticulos' class="table table-bordered table-striped">
                ...
                <?php
                  ...
                  WHERE dc.nnro_solicitud = '$nnro_solicitud' 
            ...
            <table>
              ...
              <tr>
                <td colspan="2" style="padding-top:12px;padding-bottom:12px; ">
                  ...
                  <?php
                    imprimir_boton($disabledRC,$disabledMD,$estatus,$servicios,"solicitudcompra");
                  ?>
                  <input onclick="location='../invoice/solicitudcompra.php?nnro_solicitud=<?= $nnro_solicitud;?>&nameuser=<?= $_SESSION['fullname_user'];?>'" 
                  type="button" name="btimprimir" id="8" value="Imprimir Documento" class="btn btn-default" 
                  <? if($nnro_solicitud==null){ echo "disabled";}?> />
                </td>
              </tr>
            </table>
          </form>
              ...
              function agrega_campos(){
                  $("#TablaArticulos").append("<tr id='"+contador+"'>"+
                    ...
                    "<center>"+
                      ...
                      "<input class='campo_tabla' type='text' onKeyPress='return isNumberKey(event)' name='cantidad[]' id='cantidad_"+contador+"' size='50' />"+
                    "</center>"+
                    "</td>"+
                    "<td>"+
                    "<center>"+
        ...
        <?php }else{  
          ...
          <script type="text/javascript">
            function reload_tabsc(tab){
              ...
              location.href="menu_principal.php?solicitudcompra&l&nnro_solicitud="+nnro_solicitud+"&dfecha_documento="+dfecha_documento+tab;
            }
          </script>
          <table border="0" style="width: 100%"> 
            <tr>
              ...
              <td>
                <input title="Ingrese el nro. de la órden de compra" onKeyUp="this.value=this.value.toUpperCase()" name="nnro_solicitud" id="nnro_solicitud" type="text" size="50" value="<?= $nnro_solicitud;?>" />
              </td>
              <td>
                <span class="texto_form">Fecha del Documento</span>
              </td>
          ...
          <table align="center">  
            <tr>
              <td>
                <input type="button" class="btn btn-default" value="Buscar" onclick="reload_tabsc('#solicitudcompra')">
                <input type="button" class="btn btn-default" value="Limpiar" onclick="limpiar()">
              </td>
            </tr>
          </table> 
          <a href="?solicitudcompra#solicitudcompra" ><img src="../images/cerrar.png" alt="Cerrar" style="width:40px;heigth:40px;float:right;"></a>
          <a href="../excel/excel_solicitudcompra.php" ><img src="../images/icon-excel.png" alt="Exportar a Excel" style="width:40px;heigth:40px;float:right;"></a>
          <a href="<?php echo  '../pdf/?serv=solicitudcompra';?>" target="_blank"><img src="../images/icon-pdf.png" alt="Exportar a PDF" style="width:40px;heigth:40px;float:right;"></a>
          <table style="width:100%;" class="tablapaginacion">
            ...
            $pgsql=new Conexion();
            $clausuleWhere="";
            if($nnro_solicitud!="" && $crif_persona!=""){
              $clausuleWhere.="WHERE nnro_solicitud LIKE '%$nnro_solicitud%' AND dfecha_documento LIKE '%$dfecha_documento%'";
            }
            ...
            FROM facturacion.vw_solicitudcompra
            $clausuleWhere 
            GROUP BY nnro_solicitud,dfecha_documento 
            ORDER BY nnro_solicitud DESC";
            ...
            while($row = pg_fetch_array($_pagi_result)){ 
              echo "<tr style='cursor: pointer;' id='".$row['nnro_solicitud']."' onclick='enviarForm(this.id)'>
          ...
          function enviarForm(value){
            document.getElementById('nnro_solicitud_oculto').value=value;
            document.getElementById('form').submit();
          }
          </script>
          <form id="form" method="POST" action="../controladores/control_solicitudcompra.php">
            <input type="hidden" name="nnro_solicitud" id="nnro_solicitud_oculto" value="" />
