...
include_once("../clases/class_ordenventa.php");
...
if($operacion=='Registrar'){
  ...
  if($confirmacion==1){
    ...
    if($documento->Consultar()){
      ...
      header("Location: ../vistas/menu_principal.php?ordenventa#lineaordenventa");
    }
  }else{
    $_SESSION['datos']['mensaje']="Ocurrió un error al registrar el documento.";
    header("Location: ../vistas/menu_principal.php?ordenventa#ordenventa");
  }
}
