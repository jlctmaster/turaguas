...
include_once("../clases/class_contactocliente.php");
...
if($operacion=='Registrar'){
  ...
  if($confirmacion==1){
    ...
    header("Location: ../vistas/menu_principal.php?cliente#contacto");
  }else{
...
if($operacion=='Consultar'){ 
  $contacto->crif_personacontacto($crif_personacontacto);
  if($contacto->Consultar()){
  $_SESSION['datos']['crif_personacliente']=$contacto->crif_personacliente();
    $_SESSION['datos']['cnombrecliente']=$contacto->cnombrecliente();
    ...
    $_SESSION['datos']['mensaje']="No se encontró algún resultado con el filtro de búsqueda(".$crif_personacliente.")";
    header("Location: ../vistas/menu_principal.php?cliente#contacto");
  }
}
