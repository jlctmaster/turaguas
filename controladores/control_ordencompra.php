...
include_once("../clases/class_ordencompra.php");
...
if($operacion=='Registrar'){
  ...
  if($confirmacion==1){
    ...
    if($documento->Consultar()){
      ...
      $_SESSION['datos']['cnombreproveedor']=$documento->cnombreproveedor();
      $_SESSION['datos']['cdireccionproveedor']=$documento->cdireccionproveedor();
    ...
    header("Location: ../vistas/menu_principal.php?ordencompra#ordencompra");
  }
}
...
if($operacion=='Consultar'){
  ...
  if($documento->Consultar()){
    ...
    $_SESSION['datos']['mensaje']="No se encontró algún resultado con el filtro de búsqueda(".$nnro_orden.")";
    header("Location: ../vistas/menu_principal.php?ordencompra#ordencompra");
  }
}
...
if($operacion=="BuscarDatosProveedor"){
  echo $documento->BuscarDatosProveedor($filtro);
  unset($documento);
}
