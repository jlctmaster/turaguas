...
if($operacion=='Registrar'){
  ...
  if($confirmacion==1){
    $_SESSION['datos']['mensaje']="La persona ha sido registrada con exito!";
    header("Location: ../vistas/menu_principal.php?persona");
   }else{
    $_SESSION['datos']['mensaje']="Ocurrió un error al registrar persona.";
    header("Location: ../vistas/menu_principal.php?persona");
  }
}
...
if($operacion=='Modificar'){
  ...
  $persona->cdireccion($cdireccion);
    if($persona->Actualizar($_SESSION['user_name']))
     ...
     $confirmacion=-1;
  if($confirmacion==1){
    $_SESSION['datos']['mensaje']="La persona ha sido modificada con exito!";
    header("Location: ../vistas/menu_principal.php?persona");
  }else{
    $_SESSION['datos']['mensaje']="Ocurrió un error al modificar el persona.";
    header("Location: ../vistas/menu_principal.php?persona");
  }
}
...
if($operacion=='Desactivar'){
  ...
  if($confirmacion==1){
    $_SESSION['datos']['mensaje']="La persona ha sido desactivada con exito!";
    header("Location: ../vistas/menu_principal.php?persona");
  }else{
    $_SESSION['datos']['mensaje']="Ocurrió un error al desactivar el persona.";
    header("Location: ../vistas/menu_principal.php?persona");
  }
}
...
if($operacion=='Activar'){
  ...
  if($confirmacion==1){
    $_SESSION['datos']['mensaje']="La persona ha sido activada con exito!";
    header("Location: ../vistas/menu_principal.php?persona");
  }else{
    $_SESSION['datos']['mensaje']="Ocurrió un error al activar el persona.";
    header("Location: ../vistas/menu_principal.php?persona");
  }
}
...
if($operacion=='Consultar'){ 
  ...
  if($persona->Consultar()){
    ...
    $_SESSION['datos']['mensaje']=utf8_encode("No se encontró algún resultado con el filtro de búsqueda(".$crif_persona.")");
    header("Location: ../vistas/menu_principal.php?persona");
  }
}
