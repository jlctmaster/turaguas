...
include_once("../clases/class_lineaordenrecibo.php");
...
if($operacion=='Registrar'){
  ...
  if($confirmacion==1){
    ...
    header("Location: ../vistas/menu_principal.php?ordenrecibo#lineaordenrecibo");
  }else{
...
if($operacion=='Modificar'){
  ...
  if($detalle_documento->Actualizar($_SESSION['user_name']))
    ...
    $confirmacion=-1;
  if($confirmacion==1){
    $_SESSION['datos']['mensaje']="La línea de órden ha sido modificada con exito!";
    header("Location: ../vistas/menu_principal.php?ordenrecibo#lineaordenrecibo");
  }else{
...
if($operacion=='Consultar'){	
  ...
  if($detalle_documento->Consultar()){
    ...
    $_SESSION['datos']['nnro_ent_recib']=$detalle_documento->nnro_ent_recib();
    $_SESSION['datos']['dfecha_ent_recib']=$detalle_documento->dfecha_ent_recib();
    ...
    $_SESSION['datos']['mensaje']="No se encontró algún resultado con el filtro de búsqueda(".$nlinea.")";
    header("Location: ../vistas/menu_principal.php?ordenrecibo#lineaordenrecibo");
  }
}
